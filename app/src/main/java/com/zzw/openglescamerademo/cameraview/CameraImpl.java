...
import com.zzw.openglescamerademo.cameraview.base.AspectRatio;
import com.zzw.openglescamerademo.cameraview.base.Constants;
import com.zzw.openglescamerademo.cameraview.base.Size;
import com.zzw.openglescamerademo.cameraview.base.SizeMap;
    ...
    private void startPreview() {
        ...
        processHandler = new Handler(processThread.getLooper()) {
            ...
            public void handleMessage(Message msg) {
                ...
                if (mCameraParameters != null && previewBuffer != null && mCallback != null) {
                    mCallback.onPicturePreview(CameraImpl.this, mCameraParameters.getPreviewSize().width,
                            mCameraParameters.getPreviewSize().height, previewBuffer);
                    if (mCamera != null) {
